...
const Grade10DefaultTasks: React.FC = () => {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-xl">جدول مهام المشروع الصغير</CardTitle>
                <CardDescription>
                  {isStudent ? 'تتبع تقدمك في إنجاز مشروعك الصغير خطوة بخطوة' : 'مراقبة تقدم الطلاب في المشروع الصغير'}
                </CardDescription>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <Card>
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              <p className="text-lg font-bold">{overallProgress.total}</p>
          ...
          <CardContent className="flex items-center gap-4 p-6">
            ...
            <div>
              ...
              <p className="text-green-700">
                لقد أكملت جميع مراحل المشروع الصغير. يمكنك الآن المتابعة لتقديم مشروعك.
              </p>
            </div>
          </CardContent>
        </Card>
...
export default Grade10DefaultTasks;