        ...
        {slides.map((slide, index) => (
          ...
          >
            <div className="flex flex-col md:flex-row h-full">
              ...
              <div className="flex-1 flex items-center justify-center p-6 md:p-8 bg-purple-50">
                <div className="relative">
                  ...
                  />
                  <div className="absolute -inset-3 bg-gradient-to-r from-purple-500/20 to-purple-600/20 rounded-full -z-10"></div>
                </div>
              </div>
            </div>
          </div>
