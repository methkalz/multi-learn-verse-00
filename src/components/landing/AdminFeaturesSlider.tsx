  ...
  return (
    <div className="relative max-w-5xl mx-auto px-2 sm:px-4">
      ...
      <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl overflow-hidden border border-purple-100">
        ...
        <button
          onClick={prevSlide}
          className="absolute left-1 sm:left-2 top-1/2 transform -translate-y-1/2 bg-white hover:bg-purple-50 text-purple-600 p-1.5 sm:p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110 border border-purple-100 z-20"
        >
          <ChevronLeft className="h-4 w-4 sm:h-5 sm:w-5" />
        </button>
        <button
          onClick={nextSlide}
          className="absolute right-1 sm:right-2 top-1/2 transform -translate-y-1/2 bg-white hover:bg-purple-50 text-purple-600 p-1.5 sm:p-2 rounded-full shadow-lg transition-all duration-300 hover:scale-110 border border-purple-100 z-20"
        >
