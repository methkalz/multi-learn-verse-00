            ...
            >
              <div className="flex flex-col h-full px-1 sm:px-2">
                ...
                <div className="flex-1 p-2 sm:p-4 md:p-6 lg:p-8 flex flex-col justify-center relative">
                  {/* Decorative Elements */}
                  <div className="absolute top-2 left-2 sm:top-4 sm:left-4 w-8 h-8 sm:w-16 sm:h-16 bg-blue-100 rounded-full opacity-30 animate-pulse"></div>
                  <div className="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 w-6 h-6 sm:w-12 sm:h-12 bg-blue-200 rounded-full opacity-20 animate-bounce"></div>
                  
                  <div className="relative z-10">
                    <div className="inline-block px-2 py-1 sm:px-4 sm:py-2 bg-blue-100 text-blue-800 rounded-full text-xs sm:text-sm font-medium mb-2 sm:mb-4 animate-fade-in">
                      للمعلم
                    </div>
                    ...
                    <ul className="space-y-1 sm:space-y-2 md:space-y-3">
                      {slide.features.map((feature, idx) => (
                        <li key={idx} className="flex items-center text-gray-700 animate-slide-right" style={{ animationDelay: `${0.2 + idx * 0.1}s` }}>
                          <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 md:w-2 md:h-2 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full ml-1 sm:ml-2 flex-shrink-0 animate-pulse"></div>
                  ...
                  <div className="relative z-10 group w-full max-w-[200px] sm:max-w-[300px] md:max-w-none">
                     <div className="relative transform transition-all duration-500 group-hover:scale-105">
                       ...
                       />
                        ...
                        <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-3 h-3 sm:w-5 sm:h-5 bg-blue-400 rounded-full animate-bounce pointer-events-none"></div>
                     ...
                     <div className="absolute inset-0 border border-blue-200 sm:border-2 rounded-full animate-spin-slow opacity-20 pointer-events-none"></div>
                  </div>
                </div>
              </div>
            </div>
