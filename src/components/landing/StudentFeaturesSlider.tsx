...
const StudentFeaturesSlider: React.FC = () => {
  ...
  return (
    <div className="relative max-w-5xl mx-auto px-2 sm:px-4">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-white hover:bg-green-50 text-green-600 p-2 sm:p-3 rounded-full shadow-xl transition-all duration-300 hover:scale-110 border-2 border-green-100 z-50"
      >
        <ChevronLeft className="h-4 w-4 sm:h-5 sm:w-5" />
      </button>
      <button
        onClick={nextSlide}
        className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-white hover:bg-green-50 text-green-600 p-2 sm:p-3 rounded-full shadow-xl transition-all duration-300 hover:scale-110 border-2 border-green-100 z-50"
      >
