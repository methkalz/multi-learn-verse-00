...
('Inter-VLAN Routing - التوجيه بين شبكات VLAN', 'شبكات VLAN تفصل الأجهزة إلى مجموعات منطقية، لكن الأجهزة في VLAN مختلفة لا تستطيع التواصل مع بعضها بشكل مباشر. هنا يأتي دور Inter-VLAN Routing الذي يسمح بتمرير البيانات بين VLANs مختلفة باستخدام الراوتر أو السويتش متعدد الطبقات.', 18, '00000000-0000-0000-0000-000000000000');

-- Get the section ID for section 18
