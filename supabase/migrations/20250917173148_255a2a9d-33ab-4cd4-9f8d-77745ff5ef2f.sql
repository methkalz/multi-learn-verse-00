...
DROP TRIGGER IF EXISTS update_teacher_notifications_updated_at_trigger ON public.teacher_notifications;
CREATE TRIGGER update_teacher_notifications_updated_at_trigger
